...
MIN_RANDOM_REFRESH = 2  # Minimum seconds to wait between page refreshes
MAX_RANDOM_REFRESH = 5  # Maximum seconds to wait between page refreshes

# Session refresh settings
MIN_REFRESH_COUNT = 250  # Minimum number of page refreshes before refreshing session
MAX_REFRESH_COUNT = 300  # Maximum number of page refreshes before refreshing session

# URLs
ORDERS_PAGE_URL = "https://secure.newegg.ca/orders/list"  # Orders page URL for session refreshing
SEARCH_PAGE_URL = "https://www.newegg.ca/p/pl?N=100007708%20601469153%20601469158"  # Search page URL for product search
...
# Checkout settings
PLACE_ORDER = False  # Set to False to disable actual order placement (do not click place order button - Newegg)
...
BESTBUY_ORDERS_PAGE_URL = "https://www.bestbuy.ca/order/en-ca/order-history"  # BestBuy orders page URL for session refreshing
BESTBUY_PASSWORD = "MSIPerformance1"  # Password for BestBuy account credentials
